...
fun ContentScreens(modifier: Modifier = Modifier, selectedIndex: Int) {
    Box(
        ...
        when (selectedIndex) {
            0 -> HomePage()
            1 -> MyBooksScreen(
                myBooks = remember { mutableStateListOf() }, // Provide a list of books
                onEditBook = { /* Handle edit */ },
                onDeleteBook = { /* Handle delete */ },
                // Removed unnecessary navigation callbacks here
                onHomeClick={},
                onMyBooksClick={ },
                onAddBookClick ={},
                onProfileClick ={}
...
//) {
//    Text("My Books Screen Content") // Placeholder for your actual MyBooksScreen UI
//}
...
//            onEditBook = { /* Handle edit */ },
//            onDeleteBook = { /* Handle delete */ },
//            onHomeClick = { selectedIndex = 0 }, // You might need to pass these down if MyBooksScreen needs to trigger navigation
//            onMyBooksClick = { selectedIndex = 1 },
//            onAddBookClick = { selectedIndex = 2 },
